/**
 * ISO 3166-1 country names, for the checkout country selector.
 *
 * A free-text country field is the single most common source of
 * un-shippable addresses: "USA", "U.S.", "United States of America" and
 * "Untied States" all arrive, and none of them sort, group or match a
 * carrier's country code. A fixed list makes every order resolvable.
 *
 * The names are the common English short forms rather than the formal ISO
 * titles ("South Korea", not "Korea, Republic of"), because a buyer picking
 * from a list scans for the name they use.
 *
 * NOTE: this is the full list. It is deliberately NOT a statement about where
 * Axis Labs ships or is permitted to ship — export control, sanctions and
 * per-country restrictions on research chemicals are a compliance decision,
 * not a UI one. Restricting this list is a policy change and should be made
...
/** Whether a submitted country is one this site actually offers. */
